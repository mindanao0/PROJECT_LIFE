# Benchmark Case MVP-10: Fork Bomb PID Exhaustion Attack

> **Case ID:** `MVP-10`
> **Scope:** security — ความปลอดภัย (negative case)
> **Entry point:** `src/exploit_fork.py:attack`
...
Fork Bomb PID Exhaustion Attack
...
ยังไม่มี fixture จริงในเคสนี้ — ต้องสร้าง `src/exploit_fork.py` ที่นิยาม `attack`
